...
# c = int(input('a: '))
# if a == b and b == c:
#   print(f'A triangle with sides of {a}, {b} & {c} is an equalateral')
# elif a != b and a != c and b != c:
#   print(f'A triangle with the sides of {a}, {b} & {c} is a scalene triangle')
# else:
#   print(f"A triangle with the sides of {a}, {b} and {c} is an isosceles triangle")
